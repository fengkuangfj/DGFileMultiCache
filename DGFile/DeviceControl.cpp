...
DiskDeviceControl(__in PDEVICE_OBJECT DeviceObject, __in PIRP Irp) {
	...
	irpSp = IoGetCurrentIrpStackLocation(Irp);
	dcb = (PDokanDCB)DeviceObject->DeviceExtension;
	...
	case IOCTL_VOLUME_GET_GPT_ATTRIBUTES: {
		...
		gptAttrInfo = (PVOLUME_GET_GPT_ATTRIBUTES_INFORMATION)Irp->AssociatedIrp.SystemBuffer;
	...
	case IOCTL_STORAGE_QUERY_PROPERTY:
	{
		...
		if (query->QueryType == PropertyExistsQuery) {
			if (query->PropertyId == StorageDeviceUniqueIdProperty) {
				...
				storage = (PSTORAGE_DEVICE_UNIQUE_IDENTIFIER)Irp->AssociatedIrp.SystemBuffer;
			...
			if (query->PropertyId == StorageDeviceProperty) {
				...
				storage = (PSTORAGE_DEVICE_DESCRIPTOR)Irp->AssociatedIrp.SystemBuffer;
	...
	case IOCTL_MOUNTDEV_LINK_CREATED: {
		PMOUNTDEV_NAME mountdevName = (PMOUNTDEV_NAME)Irp->AssociatedIrp.SystemBuffer;
	...
	case IOCTL_VOLUME_GET_VOLUME_DISK_EXTENTS: {
		...
		volume = (PVOLUME_DISK_EXTENTS)Irp->AssociatedIrp.SystemBuffer;
	...
	case IOCTL_STORAGE_GET_MEDIA_TYPES_EX: {
		...
		DokanPopulateDiskGeometry(&diskGeometry);
		mediaInfo->DeviceSpecific.DiskInfo.MediaType = (STORAGE_MEDIA_TYPE)diskGeometry.MediaType;
